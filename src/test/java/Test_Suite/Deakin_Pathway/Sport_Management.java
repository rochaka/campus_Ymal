package Test_Suite.Deakin_Pathway;
...
public class Sport_Management {
    ...
    void select() throws IOException,InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"form-select\"]/option[3]")).click();
    }
    @Test(priority = 4)
    void select_2() throws IOException,InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"subSelection\"]/option[5]")).click();
    }
