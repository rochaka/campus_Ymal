package Test_Suite.Teacher_Training_Diploma;
...
public class Teaching_Mathematics {
    @Test ( priority = 1 )
    ...
    void select() throws IOException, InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"form-select\"]/option[6]")).click();
    }
    ...
    void select_2() throws IOException, InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"subSelection\"]/option[4]")).click();
    }
